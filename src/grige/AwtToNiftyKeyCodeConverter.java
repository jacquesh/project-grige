...
/**
 *  Copied from the nifty-gui source (https://github.com/void256/nifty-gui/blob/1.3/nifty-renderer-jogl2/src/main/java/de/lessvoid/nifty/renderer/jogl/input/AwtToNiftyKeyCodeConverter.java)
 *  Only because I needed it and the class isn't public and is therefore inaccessible
 */

/**
 * Convert awt key codes to nifty key codes, based on lwjgl <a href="http://java-game-lib.svn.sourceforge.net/viewvc/java-game-lib/trunk/LWJGL/src/java/org/lwjgl/opengl/KeyboardEventQueue.java?revision=3116&content-type=text%2Fplain"
 * >code</a>.
 * 
 * @author acoppes
 * 
